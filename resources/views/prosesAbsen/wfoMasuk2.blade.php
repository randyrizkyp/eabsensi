  ...
  // }
        ...
        <div class="col-11">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="tptLain">
                    ...
                    @if($opdlain)
                    <option value="{{ $latopd_lain }},{{ $lotopd_lain }}">{{ $opdlain->nama_lain }}</option>
                    @endif
                </select>
            </div>
            @endif

            <button type="button" class="btn btn-primary btn-lg btn-block" onclick="cekLokasi()">Cek Lokasi</button>
        </div>
    </div>
    <div class="row  d-flex justify-content-center align-items-center">
        <div class="col-11 ">
    ...
    <div id="nomorcam" style="display: none;">
        <section style="position: relative;" class="mt-4 ">
            ...
            <div class="d-flex justify-content-center">
                <form action="/uploadFoto" method="post" enctype="multipart/form-data" id="upfoto">
                    @csrf
                    <input type="hidden" name="gambarWfo" id="gambarWfo" value="">
                    <input type="hidden" name="gambarWfo_b" id="gambarWfo_b" value="">
