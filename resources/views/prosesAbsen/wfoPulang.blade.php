    ...
    <div class="col-11">
      ...
      <div class="form-group">
        ...
        <select class="form-control" id="tptLain">
          <option value="{{ $lat }},{{ $lot }},{{ config('global.nama_lain').'-'.$unor }}">== Pilih ==</option>
          @if($tpt_lain != '')
          <option value="{{ $latlain }},{{ $lotlain }},{{ $tpt_lain }}">{{ $tpt_lain }}</option>
          @endif
          @if($opdlain)
          <option value="{{ $latopd_lain }},{{ $lotopd_lain }},{{ $opdlain->nama_lain }}">{{ $opdlain->nama_lain }}
          </option>
          @endif
        </select>
      </div>
  ...
  <div class="row wrap d-flex justify-content-center align-items-center">
    <div class="col-11 ">
      <div>
        ...
        <p class="mt-0 mb-0">Loc Kantor <span id="latKantor">{{ $lat }}</span>, <span id="lotKantor">{{ $lot }}</span>
  ...
  <div id="nomorcam" style="display: none;" class="wrap">
    <section style="position: relative;" class="mt-4" id="sectionCamera">
      ...
      <div class="d-flex justify-content-center">
        ...
        <button type="button" class="btn btn-info mt-1" id="tpic"><i class="fas fa-camera-retro"></i>&emsp;Take
          Pic
        </button>
      ...
      <div style="position : absolute; width:100%; top:0; left:0; color:darkgrey;">
        ...
        <p class="alert alert-success text-center">Buktikan Bahwa Anda di Kantor<br />Silahkan Foto Tanpa Menggunakan
          Masker</p>
    ...
    <section id="sectionSlide" style="display: none;" class="wrap">
      ...
      <div class="swiper-container">
        ...
        <div class="text-center mb-2">
          <button type="button" class="btn btn-info" onclick="retakePic();"><i class="fas fa-redo"></i>&ensp;Retake
