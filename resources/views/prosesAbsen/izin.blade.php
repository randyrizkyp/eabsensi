            ...
            <div class="col-md-12">
                <section>
                    <h3 align="center" id="menu" class="alert alert-warning mb-0" style="position: relative"><i
                        ...
                        <img class="gbab mr-2" src="/img/izin.png">Izin
                    </h3>
            ...
            <div class="col">
                <center>
                    <div class="mt-4 d-flex justify-content-center">
                        ...
                        <input type="text" name="tglawal" id="tglawal" placeholder="Tgl mulai izin " size="25">
                    </div>
        ...
        <div class="row wrap">
            <div class="col">
                <div class="mt-4 d-flex justify-content-center">
                    ...
                    <input type="text" name="tglkembali" id="tglkembali" placeholder="Tgl akhir izin " size="25">
                </div>
            </div>
        </div>
        ...
        <section id="fotspt" style="display: none;" class="wrap">
            ...
            <div id="muatan_gb">
                <div><span class="badge badge-info mt-2 mb-1 ">
                        <h5>Silahkan Foto Surat Izin</h5>
                    </span></div>
            ...
            <form action="/absensi/uploadIzin" method="post">
                @csrf
            ...
            Swal.fire({
              ...
              if (sel > 0) {
                    if(sel > 3 ){
                        ...
                        Swal.fire({
                        title: 'Anda Izin selama '+sel+' hari, siapkan surat izin anda!',
                        text: '',
                        icon: 'warning',
                        showCancelButton: true,
                        confirmButtonColor: '#3085d6',
