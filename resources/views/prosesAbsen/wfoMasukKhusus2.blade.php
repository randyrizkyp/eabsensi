...
<body>
        ...
        <div class="col">
            <section>
                <h3 align="center" id="menu" class="alert alert-success mb-0" style="position: relative"><i
                        class="fas fa-bars float-left"></i>WFO MASUK
                </h3>
    ...
    <div class="row d-flex justify-content-center mb-2">
        <div class="col-11">
            <div>
                <button type="button" class="btn btn-block btn-primary text-center" id="tokam">Ambil Gambar Dari Kamera
                </button>
    ...
    <div id="dariGallery" style="display: none">
        <form action="/uploadWfoMasukKhusus" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row d-flex justify-content-center mt-3">
                <div class="col-11">
                    <div class="form-group">
                        <label for="tujuan">Update Jam Masuk :</label>
    ...
    <div id="nomorcam" style="display: none;" class="wrap">
        <section style="position: relative;" class="mt-4" id="sectionCamera">
            ...
            <div style="position : absolute; width:100%; top:0; left:0; color:darkgrey;">
                ...
                <p class="alert alert-success text-center">Buktikan Bahwa Anda di Lingkungan Kerja<br />Silahkan Foto
                    Tanpa
                    Menggunakan
                    Masker</p>
    ...
    <div class="row justify-content-center mb-4" id="tokir" style="display: none">
        <div class="col-10 mt-4">
            <form action="/uploadWfoMasuk" method="post" id="formMasuk">
                @csrf
                {{-- <div class="form-group">
                    <label for="waktu2">Update Jam Masuk :</label>
                    <input type="text" class="form-control" id="waktu2" name="waktu"
                        value="{{ now()->format('H:i:s') }}">
                </div> --}}
