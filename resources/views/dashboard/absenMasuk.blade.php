        ...
        <div class="card shadow mb-4 p-0" width="100%">
            ...
            <div class="card-header pt-3 pb-2 d-flex flex-row align-items-center justify-content-start position-fixed bg-light"
                ...
                <div class="pilihan mr-4">
                    <a href="?pegawai=asn"
                        class="btn btn-sm {{ $status=='asn' ? 'btn-primary' : 'btn-secondary' }}">Absen Masuk ASN</a>
                    <a href="?pegawai=non"
                        class="btn btn-sm {{ $status=='non' ? 'btn-primary' : 'btn-secondary' }}">Absen Masuk
                        Non-ASN</a>
                </div>
                ...
                <div class="float-right">
                    <nav class="navbar">
                        <form class="form-inline" action="/dashboard/absenMasuk/carsen" method="get">
                            @csrf
                        ...
                        <div>
                            ...
                            <a href="/dashboard/absenMasuk?pegawai=non" class="btn btn-info ml-4 btn-sm harni"
                                name="harni">Hari
                                Ini</a>
                            @else
                            <a href="/dashboard/absenMasuk" class="btn btn-info ml-4 btn-sm harni" name="harni">Hari
                                Ini</a>
                            @endif
                        </div>
                    </nav>
                ...
                <div class="d-flex ml-4">
                    <form action="/dashboard/absenMasuk/carsen" method="get" class="mr-3">
                        @csrf
                        <input type="hidden" name="awal" value="{{ $tanggal.'-'.$bulan.'-'.$tahun }}">
                        <input type="hidden" name="kurang" value=true>
                        <button class="btn btn-sm btn-info" id="kurtang"><span
                                class="fa fa-arrow-left text-white"></span></button>
                    </form>
                    <form action="/dashboard/absenMasuk/carsen" method="get">
                        @csrf

                        <input type="hidden" name="awal" value="{{ $tanggal.'-'.$bulan.'-'.$tahun }}">
                        <input type="hidden" name="tambah" value=true>
                        <button class="btn btn-sm btn-info" id="tamtang"><span
                ...
                <table class="table table-bordered table-striped mb-0 p-0" id="absenMasuk" width="100%"
                    ...
                    <thead>
                        ...
                        <tr class="bg-yellow" style="font-size: 14px">
                            <th colspan="10">
                                @if($status == 'asn')
                                Rekap Absensi Masuk ASN
                                @else
                                Rekap Absensi Masuk Non-ASN
                                @endif
    ...
    $('#absenMasuk').DataTable({
            scrollX : true,
                    ...
                    columns: [
                        ...
                        {data: 'foto_b', name: 'foto_b', orderable: false, searchable: false},
